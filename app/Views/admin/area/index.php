                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td class="row-actions">
                              <a href="<?php echo base_url().'/area/edit/'.$dt['id_area']; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                              <form action="<?php echo base_url().'/area/'.$dt['id_area']; ?>" method="post" class="form-action-table">
                                <?php echo csrf_field(); ?>
