                  ...
                  <div class="table-responsive">
                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                      ...
                      <tbody>
                          ...
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $dt['petty_cash_group'] ?></td>
                            <td><?php echo $dt['created_at'] ?></td>
                            <td><?php echo $dt['updated_at'] ?></td>
                            <td class="row-actions">
                              <a href="<?php echo base_url().'/'.$app.'/edit/'.$dt['id_petty_cash_group']; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                              <form action="<?php echo base_url().'/'.$app.'/'.$dt['id_petty_cash_group']; ?>" method="post" class="form-action-table">
                                <?php echo csrf_field(); ?>
