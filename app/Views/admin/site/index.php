                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td class="row-actions">
                              <a href="<?php echo base_url().'/site/edit/'.$dt['id_site']; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                              <form action="<?php echo base_url().'/site/'.$dt['id_site']; ?>" method="post" class="form-action-table">
                                <?php echo csrf_field(); ?>
